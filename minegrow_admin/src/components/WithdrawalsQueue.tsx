        ...
        <div className="xl:col-span-1 glass-panel rounded-2xl p-6 shadow-2xl h-full space-y-6">
          ...
          {!selectedItem ? (
            <div className="text-center py-16 text-slate-500 text-sm">
              Select a withdrawal request from the queue to verify client banking instructions and approve settlement operations.
            </div>
          ) : (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="space-y-3">
                ...
                {selectedItem.bank_name ? (
                  ...
                  <div className="p-4 rounded-xl border border-dashed border-rose-500/20 text-center text-xs text-rose-400 flex items-center space-x-2 justify-center">
